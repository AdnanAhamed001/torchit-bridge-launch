...
const generateTemplate = () => {
  const template = {
    "version": "0.4",
    "title": "Torchit Side By Side Hero",
    "type": "section",
    "content": [
      {
        "id": generateRandomId(),
  ...
  fs.writeFileSync('side-by-side-elementor.json', JSON.stringify(template, null, 2));
  console.log('Successfully generated side-by-side-elementor.json!');
};
