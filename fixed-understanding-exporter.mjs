...
const generateTemplate = () => {
  ...
  const template = {
    "version": "0.4",
    "title": "Torchit Understanding Fixed",
    "type": "section",
    "content": [
      {
        "id": generateRandomId(),
  ...
  fs.writeFileSync('fixed-understanding-elementor.json', JSON.stringify(template, null, 2));
  console.log('Successfully generated fixed-understanding-elementor.json!');
};
