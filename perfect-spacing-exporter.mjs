...
const generateTemplate = () => {
  const pillWidgets = conditions.map(condition => ({
    ...
    "settings": {
      ...
      "margin": { "unit": "px", "top": "8", "right": "12", "bottom": "8", "left": "12", "isLinked": false },
      "align": "center",
  ...
  const template = {
    "version": "0.4",
    "title": "Torchit Understanding Perfect Spacing",
    "type": "section",
    "content": [
      {
        "id": generateRandomId(),
  ...
  fs.writeFileSync('perfect-spacing-elementor.json', JSON.stringify(template, null, 2));
  console.log('Successfully generated perfect-spacing-elementor.json!');
};
